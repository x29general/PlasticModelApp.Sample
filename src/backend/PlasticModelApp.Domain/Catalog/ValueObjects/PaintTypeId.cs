...
/// </summary>
public sealed class PaintTypeId : ValueObject
{
    /// <summary>
    ...
    public PaintTypeId(string value)
    {
        if (string.IsNullOrWhiteSpace(value))
            throw new ArgumentException("PaintTypeId cannot be empty.", nameof(value));

        Value = value;
    }

    /// <summary>
    /// Creates a PaintTypeId from an existing identifier string.
    /// </summary>
    public static PaintTypeId From(string value) => new(value);
